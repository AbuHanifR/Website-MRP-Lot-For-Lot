...
<head>
    ...
    <title>Laporan Perencanaan Kebutuhan Bahan Baku Per Bulan</title>
...
<body>
    <center>
        ...
        <hr style="border: 2;">
        <h4 class="text-center mt-2 mb-2">Laporan Perencanaan Kebutuhan Bahan Baku Per Bulan</h4>
        <h4 class="text-center mt-2 mb-2">Bulan {{$month}} Tahun {{$year}}
        </h4>
    </center>
