...
<div class="row">
    ...
    <div class="col-xl-12 col-lg-12 col-md-12 col-sm-12 col-12">
        <div class="card">
            <div class="container">
                <div class="row">
                    <h3 class="card-header m-4 text-left">Laporan Master Production Schedule</h3>
                    ...
                    <table class="table table-striped table-bordered first">
                        ...
                        <tbody>
                            ...
                            <tr>
                                ...
                                <td>
                                    <a href="laporan_mps/detail/{{ $mp->id_mps}}" class="badge badge-pill badge-primary">Detail</a>
