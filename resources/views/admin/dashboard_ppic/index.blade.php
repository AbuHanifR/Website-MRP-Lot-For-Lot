...
<div class="row">
    ...
    <div class="col-xl-3 col-lg-3 col-md-6 col-sm-12 col-12">
        <div class="card border-3 border-top border-top-primary">
            <div class="card-body">
                <h5 class="text-muted">Total Bahan Baku</h5>
                <div class="metric-value d-inline-block">
                    <h1 class="mb-1">{{$bahan}}</h1>
                </div>
    ...
    <div class="col-xl-3 col-lg-3 col-md-6 col-sm-12 col-12">
        <div class="card border-3 border-top border-top-primary">
            <div class="card-body">
                <h5 class="text-muted">Total Bill Of Material</h5>
                <div class="metric-value d-inline-block">
                    <h1 class="mb-1">{{$bom}}</h1>
                </div>
