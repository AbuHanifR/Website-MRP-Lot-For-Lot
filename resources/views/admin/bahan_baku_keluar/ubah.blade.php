    ...
    <div class="col-xl-12 col-lg-12 col-md-12 col-sm-12 col-12">
        <div class="card">
            <div class="card-header">
                <h5 class="mb-0">Ubah Bahan Baku Keluar</h5>
                        ...
                        <tbody>
                            ...
                            @foreach ($detail as $no => $trsk)
                                <tr>
                                    ...
                                    <td>
                                    <a href="{{route('detailbahanbakukeluar.edit',[$trsk->id_detail_bahan_baku_keluar])}}" class="badge badge-pill badge-warning">Ubah</a>
                                    <a href="{{route('detailbahanbakukeluar.hapus',[$trsk->id_detail_bahan_baku_keluar])}}" class="badge badge-pill badge-danger">Hapus</a>
                                    </td>
                                </tr>
                                @endforeach
                        </tbody>
            ...
            <div class="col-sm-6 pl-0">
                <p class="text-center">
                    ...
                    <a type="button" class="btn btn-space btn-secondary"
                        href="{{ route('bahan_baku_keluar.index') }}">Kembali</a>
                </p>
            </div>
        </div>
