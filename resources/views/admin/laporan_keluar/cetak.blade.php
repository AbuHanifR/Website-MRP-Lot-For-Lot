...
<body>
    <center>
        ...
        <hr style="border: 2;">
        <h3 class="text-center mt-2 mb-2">Laporan Bahan Baku Keluar</h3>
                    ...
                    <tbody>
                        @foreach ($laporan as $no => $lpn)
                                    <tr>
                                        ...
                                        <td align="center">{{ $lpn->id_transaksi_keluar}}</td>                            
                                        <td align="center">{{ $lpn->nama_bahan_baku }}</td>
                                        <td align="center">{{ $lpn->jumlah_keluar }}</td>
                                        <td align="center">{{ $lpn->tanggal_keluar }}</td>
                                        <td align="center">{{ $lpn->keperluan }}</td>
                                    </tr>
                                @endforeach
                    </tbody>
