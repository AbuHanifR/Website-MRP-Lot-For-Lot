...
<div class="row">
    <div class="col-xl-12 col-lg-12 col-md-12 col-sm-12 col-12">
        <div class="page-header">
            <h2 class="pageheader-title">Laporan Bahan Baku Keluar</h2>
            <p class="pageheader-text"></p>
            <div class="page-breadcrumb">
                <nav aria-label="breadcrumb">
                    <ol class="breadcrumb">
                        <li class="breadcrumb-item"><a class="breadcrumb-link">Laporan Bahan Baku Keluar</a></li>
                        <li class="breadcrumb-item active" aria-current="page">Laporan Bahan Baku Keluar</li>
                    </ol>
                </nav>
            </div>
        </div>
...
<div class="row">
    ...
    <div class="col-xl-12 col-lg-12 col-md-12 col-sm-12 col-12">
        <div class="card">
            <div class="container">
                <div class="row">
                    <h3 class="card-header m-4 text-left">Laporan Bahan Baku Keluar</h3>
                </div>
            </div>
            ...
            <div class="card-body">
                ...
                <form action="/laporan_keluar" method="GET">
                    @csrf
